...
- **Инструменты разработчика в браузере**
    ...
    - [Chrome DevTools](https://developers.google.com/web/tools/chrome-devtools/) :gb:
    - [Инструменты разработчика Firefox](https://developer.mozilla.org/ru/docs/Tools/Web_Console) :ru:
    - [Firefox Developer Tools](https://developer.mozilla.org/en-US/docs/Tools/Debugger) :gb:
...
- **Основы**
    ...
    - [Основы JavaScript](https://html5book.ru/osnovy-javascript/) :ru:
    - [JavaScript Tutorial](https://www.w3schools.com/js/) :gb:
    - [Фундаментальные принципы объектно-ориентированного программирования на JavaScript](https://tproger.ru/translations/oop-js-fundamentals/) :ru:
    - [ECMAScript Specification](https://tc39.github.io/ecma262/) :gb:
    
- **[DOM](https://ru.wikipedia.org/wiki/Document_Object_Model)**

    - [DOM](https://developer.mozilla.org/ru/docs/DOM) :ru:
    - [Объектная модель документа: что такое DOM и чем не является?](https://proglib.io/p/what-is-dom/) :ru:

- **Fetch API & [AJAX(XHR)](https://ru.wikipedia.org/wiki/XMLHttpRequest)**
    
    - [Введение в fetch](https://habr.com/ru/post/252941/) :ru:
    - [Практическое ES6 руководство, о том, как сделать HTTP запрос с помощью Fetch API](http://jem-space.ru/praktichieskoie-es6-rukovodstvo-o-tom-kak-sdielat-http-zapros-s-pomoshchiu-fetch-api/) :ru:
    - [AJAX](https://ru.wikibooks.org/wiki/AJAX) :ru:
    
- **ES6+ и модули JavaScript**

    - [Шпаргалка по современному JavaScript](https://tproger.ru/translations/javascript-cheatsheet/) :ru:
    - [ES6, ES8, ES2017: что такое ECMAScript и чем это отличается от JavaScript](https://tproger.ru/translations/wtf-is-ecmascript/) :ru:
    - [Обзор новшеств ECMAScript 2016, 2017, и 2018 с примерами](https://habr.com/ru/company/ruvds/blog/353174/) :ru:
    - [What’s coming to Javascript (ES7 + ES8)](https://medium.com/@Murcul/whats-coming-to-javascript-es7-es8-8ce73c9a8ec9) :gb:
    - [Глубокое погружение в ES-модули в картинках](https://medium.com/web-standards/es-modules-cartoon-dive-71f42c1e851a) :ru:
    - [JavaScript модули. Руководство для начинающих.](https://tuhub.ru/posts/javascript-moduli-rukovodstvo-dlya-nachinayushhih) :ru:

- **Шпаргалки**

    - [JavaScript Cheat Sheet](https://websitesetup.org/javascript-cheat-sheet/) :gb:
